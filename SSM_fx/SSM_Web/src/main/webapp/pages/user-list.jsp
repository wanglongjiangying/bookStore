                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Previous" aria-label="Next">尾页</a></li>
                        </ul>
                    </div>
...
<script>
    ...
    function changePageNum(){
        ...
        location.href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.pageNum}&size="+size;
    }
