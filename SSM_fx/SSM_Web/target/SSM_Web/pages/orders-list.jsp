                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button onclick="deleteOrders()" type="button" class="btn btn-default" title="删除">
                            ...
                            <c:forEach items="${pageInfo.list}" var="orders">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs"><a  style="color: white" href="${pageContext.request.contextPath}/orders/deleteById.do?id=${orders.id}">删除</a> </button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
   ...
   function deleteOrders(){
      var ids=$('input:checkbox[name="ids"]:checked');
       if(ids.length<1){
           ...
           location.href="${pageContext.request.contextPath}/orders/deleteMany.do?ids="+data;
       }
   }
