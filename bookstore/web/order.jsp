		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<form id="orderForm" action="${pageContext.request.contextPath}/addorder" method="post">
						<table cellspacing="0" class="infocontent">
							<tr>
								<td><table width="100%" border="0" cellspacing="0">
										<tr>
											<td><img src="images/buy2.gif" width="635" height="38" />
												<p>您好：${user_session.username}先生！欢迎您来到商城结算中心</p></td>
										</tr>
										<tr>
											<td><table cellspacing="1" class="carttable">
												...
												<p>
													...
													收货地址：<input name="receiverAddress" type="text"  style="width:350px" />&nbsp;&nbsp;&nbsp;&nbsp;
													<!--<a href="#"></a>-->
													<br />
													收货人：&nbsp;&nbsp;&nbsp;&nbsp;<input name="receiverName" type="text"  style="width:150px" />&nbsp;&nbsp;&nbsp;&nbsp;
											    	<!--<a href="#"></a>-->
													<br />
												...
												<p style="text-align:right">
													...
													<img onclick="submitOrderForm()" src="images/gif53_029.gif" width="204" height="51" border="0" />
												</p></td>
										</tr>
									</table></td>
							</tr>
