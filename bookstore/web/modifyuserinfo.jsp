					...
					<table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath}/findUserById?userId=${user_session.id}">用户信息修改</a></td>
						</tr>
								...
								<form action="${pageContext.request.contextPath}/updateUser" method="post">
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										...
										<tr>
											...
											<td><input type="password" name="password" class="textinput" value="${user.password}"/></td>

											<td><font color="#999999">密码设置至少6位，请区分大小写</font></td>
										</tr>
										<tr>
											<td style="text-align:right">重复密码：</td>
											<td><input type="password" class="textinput" value="${user.password}"/>
											</td>
											<td>&nbsp;</td>
										</tr>
										...
										<tr>
											...
											<td colspan="2">&nbsp;&nbsp;
												...
												&nbsp;&nbsp;&nbsp;&nbsp;
												&nbsp<input type="radio" name="gender" value="女"  ${user.gender=='女'?'checked="checked"':''} /> 女</td>
										</tr>
										<tr>
