        ...
        <tr>
            ...
            <td style="padding:5px 15px 10px 40px"><table width="100%"
                ...
                <table width="100%" border="0" cellspacing="0">
                    <tr>
                        <td style="width:50px; text-align:center"><a href="${pageContext.request.contextPath}/productInfo?id=28"><img
                                src="bookcover/travelbook.jpg" width="102" height="130"
                                border="0" /> </a><br /> <a href="${pageContext.request.contextPath}/productInfo?id=28">TravelBook<br />
                            作者:Lonley Plant</a></td>
                        <td style="width:50px; text-align:center"><a href="${pageContext.request.contextPath}/productInfo?id=13"><img
                                src="bookcover/java2.jpg" width="102" height="130" border="0" />
                        </a><br /> <a href="${pageContext.request.contextPath}/productInfo?id=13">Java2入门经典(JDK5) <br /> 作者:(美)霍顿</a>
                        </td>
                    </tr>
                </table></td>
        </tr>
