...
<form id="Form1" name="Form1"
      action="${pageContext.request.contextPath}/admin/findProductByPage"
      method="post">
            ...
            <td class="ta_01" align="center" bgColor="#f5fafe">
                    ...
                    <c:forEach items="${pageResult.list}" var="product">
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td align="center" style="HEIGHT: 22px" width="7%"><a
                                    href="${pageContext.request.contextPath}/admin/editProduct?id=${product.id}">
                                <img
                            ...
                            <td align="center" style="HEIGHT: 22px" width="7%"><a
                                    href="${pageContext.request.contextPath}/admin/deleteProduct?id=${product.id}">
                                <img
                ...
                <div class="pagination">
                    ...
                    <ul>
                        ...
                        <c:if test="${pageResult.currentPage!=1}">
                            <li><a href="${pageContext.request.contextPath}/admin/findProductByPage?currentPage=${pageResult.currentPage-1}">上一页&lt;&lt;</a></li>
                        </c:if>
                        ...
                        <c:forEach begin="1" end="${pageResult.totalPage}" var="i">
                            ...
                            <c:if test="${pageResult.currentPage==i}">
                                <li>
                                    <a style="background-color: lightsalmon"  href="${pageContext.request.contextPath}/admin/findProductByPage?currentPage=${i}">${i}</a>
                                </li>
                            </c:if>
                            <c:if test="${pageResult.currentPage!=i}">
                                <li >
                                    <a href="${pageContext.request.contextPath}/admin/findProductByPage?currentPage=${i}">${i}</a>
                                </li>
                            </c:if>
                        ...
                        <c:if test="${pageResult.currentPage!=pageResult.totalPage}">
                            <li><a href="${pageContext.request.contextPath}/admin/findProductByPage?currentPage=${pageResult.currentPage+1}">下一页&gt;&gt;</a></li>
                        </c:if>
                    </ul>
                </div>
